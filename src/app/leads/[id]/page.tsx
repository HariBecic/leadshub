...
import { ArrowLeft, Mail, Phone, MapPin, Tag, User, Calendar, Shield } from 'lucide-react'
...
export default function LeadDetailPage() {
  ...
  // Get extra_data and filter out base fields and empty values
  ...
  // Separate persons/people from other data
  ...
  const nestedExtraData = extraData.extra_data ? Object.entries(extraData.extra_data).filter(([_, v]) => v && v !== '') : []
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {lead.category && (
                <div className="flex items-center gap-3">
                  ...
                  <span className="badge badge-info">{(lead.category as any).name}</span>
                </div>
              )}
            </div>
          </div>

          {/* Personen (falls vorhanden) */}
          ...
          {(otherData.length > 0 || nestedExtraData.length > 0) && (
            <div className="card">
              <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
          ...
          <div className="card">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <span>{new Date(lead.created_at).toLocaleDateString('de-CH')} {new Date(lead.created_at).toLocaleTimeString('de-CH', { hour: '2-digit', minute: '2-digit' })}</span>
              </div>
              <div className="flex justify-between">
